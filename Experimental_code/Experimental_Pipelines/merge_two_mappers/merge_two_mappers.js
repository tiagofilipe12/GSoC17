...
// === DUPLICATED TASKS ===
/*
This uses name of tasks to generate uid because otherwise it is
 impossible to make a junction of tasks that have same props.input
 props.output and props.params.
With props.name we can give a name for the task as best pratice and use
 it to constract a unique hash.
Task duplication may be annooying but the alternative is to not having
 watermill check if a task has already been run.
 */
